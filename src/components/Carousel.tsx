...
export default function Carousel() {
  const slides = [
    {
      url: "https://rare-gallery.com/uploads/posts/538616-peaky-blinders.jpg",
    },
    {
  ...
  return (
    <div className="bg-primary h-[500px] sm:h-[700px] lg:h-[800px] xl:h-[900px] w-full m-auto mt-6 relative group">
      <div
